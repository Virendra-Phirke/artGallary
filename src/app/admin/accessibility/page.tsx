...
export default async function AdminAccessibilityPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      <div className="p-8 bg-[#14151a] border border-[#262833] rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-6 shadow-xl">
        <div className="space-y-2">
          <span className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">
            Overall WCAG Score
          </span>
          <div className="flex items-baseline gap-3">
            <span className="font-serif text-5xl text-white font-medium">
              {scorePercentage}%
            </span>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 bg-[#14151a] border border-[#262833] rounded-xl space-y-2">
      ...
      {missingAltText.length > 0 && (
        <div className="p-6 bg-[#14151a] border border-amber-900/40 rounded-2xl space-y-4">
            ...
            {missingAltText.map((art) => (
              ...
              >
                ...
                <Link
                  ...
                  className="text-xs text-[#d1a86e] hover:underline flex items-center gap-1"
                >
