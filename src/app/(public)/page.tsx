...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-28 md:space-y-36 pb-20">
      ...
      {featuredCollection && (
        <section className="bg-[#101116] border-y border-[#1c1d25] py-24">
        ...
        <div className="relative rounded-2xl bg-gradient-to-br from-[#14151a] to-[#181920] border border-[#262833] p-8 md:p-14 overflow-hidden shadow-2xl">
          <div className="max-w-2xl space-y-6 relative z-10">
            <div className="inline-flex items-center gap-2 text-xs tracking-widest text-[#d1a86e] uppercase font-semibold">
              <Sparkles className="w-4 h-4" />
              <span>Spatial WebAR Technology</span>
            </div>
            <h2 className="font-serif text-3xl md:text-5xl text-white">
              View Original Works in Your Interior Space
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                href="/ar/solitude-in-ultramarine"
                className="flex items-center gap-2 bg-[#d1a86e] hover:bg-[#e2c18d] text-[#0d0e12] px-7 py-3.5 rounded-full text-xs font-semibold uppercase tracking-[0.2em] transition-all"
              >
      ...
      <section className="max-w-5xl mx-auto px-6 md:px-12 text-center space-y-8">
        ...
        <blockquote className="font-serif text-2xl sm:text-3xl md:text-4xl text-white font-light italic leading-snug">
          &ldquo;A painting is not merely an image hanging upon a partition; it is an alteration of the atmospheric silence within a room.&rdquo;
        </blockquote>
          ...
          <div className="border-t border-[#1c1d25] pt-14 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              <div className="relative aspect-[16/9] rounded-lg overflow-hidden border border-[#262833]">
                <Image
                  src={currentExhibition.coverImageUrl}
