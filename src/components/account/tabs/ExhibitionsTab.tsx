    ...
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="space-y-6">
        {paginatedExhibitions.map((exh) => (
          <div
            key={exh.id}
            className="bg-[#14151a] border border-[#262833] rounded-3xl p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center shadow-xl hover:border-[#d1a86e]/30 transition-all duration-300"
          >
            {exh.coverImageUrl && (
